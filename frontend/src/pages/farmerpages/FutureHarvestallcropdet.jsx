...
import { getfutharvestcropdetails } from '../../api/api'

const FutureHarvestallcropdet = () => {
  const { id } = useParams()
  ...
  return (
    <div className="w-screen h-screen flex bg-green-50">
      ...
      <div className="flex flex-col flex-1 overflow-y-auto">
        ...
        <div className="p-6">
          <div className="rounded-lg p-6 shadow-sm min-h-[300px] bg-white">
            ...
            <div className="flex flex-col lg:flex-row gap-10 mt-2">
              ...
              <div className="lg:w-1/2">
                ...
                {/* FARMER PROFILE – SAME AS HARVESTED */}
                {crop.farmerId && (
                  <div className="mt-6 rounded-xl p-4 flex items-center gap-4">
                    ...
                    <div className="font-mono text-sm space-y-1">
                      ...
                      <p className="text-green-700">
                        {crop.farmerId.farmName}
                      </p>
                      <p className="text-amber-800">
                        {crop.farmerId.farmLocation}
                      </p>
              ...
              <div className="lg:w-1/2 text-gray-600 leading-relaxed text-lg space-y-4 font-mono">
                <p className="font-semibold text-green-900">
                  Expected on:
                  <span className="font-serif font-thin text-base text-amber-900 ml-2">
...
export default FutureHarvestallcropdet
